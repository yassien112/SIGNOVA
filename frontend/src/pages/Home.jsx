      ...
      <section className='hero-section'>
        <div className='hero-content'>
          ...
          <h1>
            ...
            <span className='gradient-text'>Signova</span>
          </h1>
          <p className='hero-subtitle'>
            A modern communication platform designed to help people with
            disabilities connect seamlessly through AI-powered sign language
            recognition and real-time messaging.
          </p>
          ...
          <div className='glass-card'>
            ...
            <div className='mockup-body'>
              <div className='mock-chat'>
                <div className='mock-msg mock-receive'>
                  Hello, nice to meet you!
                </div>
                <div className='mock-msg mock-send'>
